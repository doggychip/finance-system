...
export const BS_LINES: BSLineItem[] = [
  ...
  { code: 'A_303010', label: '303010 Amount due to/from Holding (Non-trade)', indent: 2, account_codes: ['303010'] },
  { code: 'A_303011', label: '303011 Amount due to/from Holding W3 (Non-trade)', indent: 2, account_codes: ['303011'] },
  { code: 'A_303040', label: '303040 Amount due to/from Xterlabs (Non-trade)', indent: 2, account_codes: ['303040'] },
  { code: 'A_303041', label: '303041 Amount due to/from Xterlabs W3 (Non-trade)', indent: 2, account_codes: ['303041'] },
  { code: 'A_303050', label: '303050 Amount due to/from Overworld (Non-trade)', indent: 2, account_codes: ['303050'] },
  { code: 'A_303051', label: '303051 Amount due to/from Overworld W3 (Non-trade)', indent: 2, account_codes: ['303051'] },
  { code: 'A_303160', label: '303160 Amount due to/from REACH LABS (Non-trade)', indent: 2, account_codes: ['303160'] },
  { code: 'A_303161', label: '303161 Amount due to/from REACH LABS W3 (Non-trade)', indent: 2, account_codes: ['303161'] },
  { code: 'A_303170', label: '303170 Amount due to/from Rough House Games (Non-trade)', indent: 2, account_codes: ['303170'] },
  { code: 'A_303171', label: '303171 Amount due to/from Rough House Games W3 (Non-trade)', indent: 2, account_codes: ['303171'] },
  { code: 'A_303060', label: '303060 Amount due to/from Quantummind Solutions HK (Non-trade)', indent: 2, account_codes: ['303060'] },
  { code: 'A_303061', label: '303061 Amount due to/from PALIO W3 (Non-trade)', indent: 2, account_codes: ['303061'] },
  { code: 'A_303140', label: '303140 Amount due to/from Play Algorithm (BVI) (Non-trade)', indent: 2, account_codes: ['303140'] },
  { code: 'A_303070', label: '303070 Amount due to/from Shadowcay (Non-trade)', indent: 2, account_codes: ['303070'] },
  { code: 'A_303071', label: '303071 Amount due to/from Shadowcay W3 (Non-trade)', indent: 2, account_codes: ['303071'] },
  { code: 'A_303080', label: '303080 Amount due to/from Gamephilos (Non-trade)', indent: 2, account_codes: ['303080'] },
  { code: 'A_303081', label: '303081 Amount due to/from Gamephilos W3 (Non-trade)', indent: 2, account_codes: ['303081'] },
  { code: 'A_303090', label: '303090 Amount due to/from COS Games (Non-trade)', indent: 2, account_codes: ['303090'] },
  { code: 'A_303091', label: '303091 Amount due to/from COS Games W3 (Non-trade)', indent: 2, account_codes: ['303091'] },
  { code: 'A_303110', label: '303110 Amount due to/from Privilege HK (Non-trade)', indent: 2, account_codes: ['303110'] },
  { code: 'A_303120', label: '303120 Amount due to/from collected on behalf (Non-trade)', indent: 2, account_codes: ['303120'] },
  { code: 'A_303150', label: '303150 Amount due to/from Libecciotech Station (Non-trade)', indent: 2, account_codes: ['303150'] },
  { code: 'A_303020', label: '303020 Amount due to/from Libecciotech (Non-trade)', indent: 2, account_codes: ['303020'] },
  { code: 'A_303021', label: '303021 Amount due to/from Libecciotech W3 (Non-trade)', indent: 2, account_codes: ['303021'] },
  { code: 'A_303180', label: '303180 Amount due to/from REACH LABS (Non-trade)', indent: 2, account_codes: ['303180'] },
  { code: 'A_303181', label: '303181 Amount due to/from REACH LABS W3 (Non-trade)', indent: 2, account_codes: ['303181'] },
  { code: 'A_303100', label: '303100 Amount due to/from FunPlus (Non-trade)', indent: 2, account_codes: ['303100'] },
  { code: 'A_303031', label: '303031 Amount due to/from Xterio Foundation (Non-trade)', indent: 2, account_codes: ['303031'] },
  ...
  { code: 'A_500000', label: 'Retained Earnings', indent: 2, account_codes: ['500000'] },
  { code: 'A_310000', label: 'Share Capitals', indent: 2, account_codes: ['310000'] },
  { code: 'A_201000', label: 'Capital in Wallet', indent: 2, account_codes: ['201000'] },
